...
Link to the tutorial video can be found [here](https://youtu.be/yDDMNh2-fbk). The interactive notebook is available  from the [workshop webpage](https://www.mlip-workshop-2021.xyz/resources). 
